  ...
  return (
    <main className="bg-[#f6f2fb] text-gray-800">
      <section className="py-20 px-6 max-w-4xl mx-auto">
        <h1 className="text-4xl md:text-5xl font-semibold text-purple-800 mb-8">
          Lavender at JW Farms
        </h1>

        <p className="mb-6 text-lg leading-relaxed">
          Lavender has been part of daily life for generations — valued for its
          fragrance, usefulness, and steady presence. At JW Farms, we grow
        ...
        <h2 className="text-2xl font-semibold text-purple-800 mt-12 mb-4">
          What Is Lavender?
        </h2>

        <p className="mb-6 leading-relaxed">
          Lavender is a flowering perennial known for known for its aromatic buds
          and adaptability. While many varieties exist, lavender has long been
        ...
        <ul className="list-disc pl-6 mb-6 space-y-2">
          <li>Healthy plants grown with intention</li>
          <li>Careful harvest timing</li>
          <li>Proper drying and storage</li>
          <li>Respect for the natural rhythm of the land</li>
        </ul>
